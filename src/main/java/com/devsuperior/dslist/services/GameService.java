...
public class GameService {
	...
	public List<GameMinDTO> findByList(Long listId) {
		List<GameMinProjection> result = gameRepository.searchByList(listId);// List<Game>
		return result.stream().map(x -> new GameMinDTO(x)).toList();// stream sequência de dados //map
																					// transforma
